...
ifneq ($(filter 4.6 4.6.% 4.7 4.7.% 4.8 4.8-sm, $($(combo_2nd_arch_prefix)TARGET_GCC_VERSION)),)
...
#
$(combo_2nd_arch_prefix)TARGET_GLOBAL_CFLAGS += -O3 -Wno-psabi -Wno-array-bounds
