...
$(combo_var_prefix)GLOBAL_CFLAGS := -fno-exceptions -Wno-multichar -ftree-vectorize -funsafe-math-optimizations
$(combo_var_prefix)RELEASE_CFLAGS := -O2 -g -fno-strict-aliasing -ftree-vectorize -funsafe-math-optimizations
