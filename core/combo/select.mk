...
$(combo_target)GLOBAL_CFLAGS := -O2 -g -fmodulo-sched -fmodulo-sched-allow-regmoves -fivopts -ftree-vectorize -fno-exceptions -Wno-multichar
$(combo_target)RELEASE_CFLAGS := -O2 -fivopts -pipe -Wno-non-virtual-dtor -Wstrict-aliasing=2
