...
CLANG_CONFIG_EXTRA_CFLAGS := -O3 -fvectorize -ffast-math -fno-unsafe-math-optimizations -fstrict-aliasing -munaligned-access -pipe -Qunused-arguments -Wno-unknown-warning-option
CLANG_CONFIG_EXTRA_CPPFLAGS := -O3 -fvectorize -ffast-math -fno-unsafe-math-optimizations -fstrict-aliasing -munaligned-access -pipe -Qunused-arguments -Wno-unknown-warning-option
